...
public class UserDAO {
	...
	@SuppressWarnings("unchecked")//(Reason to add)Type safety: The expression of type List needs unchecked conversion to conform to List<User>
	...
	public void updateUser(User user) {
		String sql = "";
		if (user.getID() == 0) {
			user.setDate_added(Calendar.getInstance().getTime());
