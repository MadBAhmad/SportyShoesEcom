...
<body>
<jsp:include page="/WEB-INF/view/headers/header.jsp" ></jsp:include>
<jsp:include page="/WEB-INF/view/headers/topbar.jsp" ></jsp:include>
...
<jsp:include page="/WEB-INF/view/headers/footer.jsp"></jsp:include>
</body>
</html>